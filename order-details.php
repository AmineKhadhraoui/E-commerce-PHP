		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-total item">Somme finale</th>
					<th class="cart-total item">Methode de Paiment</th>
...
<?php $cnt=$cnt+1;} } else { ?>
				<tr><td colspan="8">L'identifiant de la commande ou l'identifiant de l'e-mail enregistré n'est pas valide</td></tr>
				<?php } ?>
			</tbody><!-- /tbody -->
		</table><!-- /table -->

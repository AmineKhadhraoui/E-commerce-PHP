...
?>
						...
						<div class="rating">
							...
							<span class="review">( <?php echo htmlentities($num);?> Commentaires )</span>
						</div>
						<?php } ?>
						<div class="price">
							<?php echo htmlentities($row['pprice']);?>.00  Dt
							<span>90.00 Dt</span>
						</div>
					</td>
					<td class="col-md-2">
				...
				<?php } } else{ ?>
				<tr>
					<td style="font-size: 18px; font-weight:bold ">List des Favoris est vide !!</td>

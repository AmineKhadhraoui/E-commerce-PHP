...
<html lang="en">
	<head>
	    ...
	    <title>Portail d'achat | Mot de passe oublié</title>
	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'>Mot de passe oubliée</li>
			</ul>
...
?>
		...
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    <label class="info-title" for="exampleInputPassword1">N° Contact <span>*</span></label>
...
<div class="form-group">
	    	<label class="info-title" for="confirmpassword">Confirmé Mot De Passe . <span>*</span></label>
	    	<input type="password" class="form-control unicase-form-control text-input" id="confirmpassword" name="confirmpassword" required >
	  	</div>


		
	  	<button type="submit" class="btn-upper btn btn-primary checkout-page-button" name="change">Changé</button>
	</form>					
</div>
<!-- Sign-in -->

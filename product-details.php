...
if(isset($_GET['action']) && $_GET['action']=="add"){
	...
	if(isset($_SESSION['cart'][$id])){
		...
		echo "<script type='text/javascript'> document.location ='my-cart.php'; </script>";
			...
			$message="L'ID de produit n'est pas valide";
		}
	}
}
$pid=intval($_GET['pid']);
					...
					<div class="products">
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">	
								<span class="price">
									 <?php echo htmlentities($rws['productPrice']);?>   Dt
								</span>
									
							    <span class="price-before-discount"><?php echo htmlentities($row['productPriceBeforeDiscount']);?>	 Dt</span>					
						...
						<div class="cart clearfix animate-effect">
							...
							<button class="btn btn-primary" type="button">Ajouter au Panier</button></a>
								<?php } else {?>
							<div class="action" style="color:red">En Stock</div>
					<?php } ?>
...
?>		
							<div class="rating-reviews m-t-20">
								<div class="row">
									...
									<div class="col-sm-8">
										<div class="reviews">
											<a href="#" class="lnk">(<?php echo htmlentities($num);?> Commentaires)</a>
										</div>
									</div>
								</div><!-- /.row -->		
							</div><!-- /.rating-reviews -->
...
<div class="stock-container info-container m-t-10">
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											<span class="price"> <?php echo htmlentities($row['productPrice']);?>   Dt</span>
											<span class="price-strike"><?php echo htmlentities($row['productPriceBeforeDiscount']);?>   Dt</span>
										</div>
									</div>
...
<?php if($row['productAvailability']=='In Stock'){?>
										<a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i> Ajouter au Panier</a>
													<?php } else {?>
							<div class="action" style="color:red">Hors Stock</div>
					<?php } ?>
									</div>
							...
							<div class="product-social-link m-t-20 text-right">
								...
								<div class="social-icons">
						            <ul class="list-inline">
						                <li><a class="fa fa-facebook" href="https://www.facebook.com/SwiftMediaPlusPlus/"></a></li>
						            </ul><!-- /.social-icons -->
						        </div>
							</div>
					...
					<div class="row">
						<div class="col-sm-3">
							<ul id="product-tabs" class="nav nav-tabs nav-tab-cell">
								...
								<li><a data-toggle="tab" href="#review">COMMENTAIRE</a></li>
...
?>
											...
											<div class="reviews" style="border: solid 1px #000; padding-left: 2% ">
												<div class="review">
													...
													<div class="text"><b>Qualité :</b>  <?php echo htmlentities($rvw['quality']);?> Etoile</div>
													<div class="text"><b>Prix :</b>  <?php echo htmlentities($rvw['price']);?> Etoile</div>
													<div class="text"><b>valuer :</b>  <?php echo htmlentities($rvw['value']);?> Etoile</div>
										...
										<div class="product-add-review">
											<h4 class="title">Rédigez votre propre avis</h4>
														...
														<div class="row">
															<div class="col-sm-6">
																<div class="form-group">
																	<label for="exampleInputName">Ton Nom <span class="astk">*</span></label>
...
while($rw=mysqli_fetch_array($qry))
{
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					<?php echo htmlentities($rw['productPrice']);?>		Dt	</span>
										     <span class="price-before-discount">
										     <?php echo htmlentities($rw['productPriceBeforeDiscount']);?>	  Dt</span>

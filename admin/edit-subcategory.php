...
<html lang="en">
<head>
	<meta http-equiv="Content-Type" content="text/html; chaet=utf-8" />
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Editer les Sous Categorie</h3>
							</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">Nom du Sous Categorie</label>
<div class="controls">
<input type="text" placeholder="Entrer Nom du Sous Categorie"  name="subcategory" value="<?php echo  htmlentities($row['subcategory']);?>" class="span8 tip" required>
</div>
</div>
...
<?php include('include/footer.php');?>
	...
	<script>
		$(document).ready(function() {
			...
			$('.dataTables_paginate > a:fit-child').append('<i class="icon-chevron-left shaded"></i>');

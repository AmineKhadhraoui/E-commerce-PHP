...
$_SESSION['msg']="Sous categorie Crée !!";
...
<option value="">Selectionnée une Categorie</option> 
...
<div class="controls">
<input type="text" placeholder="Entrer le noum du Sous Categorie"  name="subcategory" class="span8 tip" required>
</div>
</div>
...
?>									
										<tr>
											...
											<a href="subcategory.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Etes-vous sûr que vous voulez supprimer?')"><i class="icon-remove-sign"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>

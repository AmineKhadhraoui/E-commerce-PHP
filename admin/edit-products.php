...
<div class="control-group">
<label class="control-label" for="basicinput">Entreprise du produit</label>
<div class="controls">
...
<div class="controls">
<input type="text"    name="productpricebd"  placeholder="Entrer le Prix ​​du produit avant remise<" value="<?php echo htmlentities($row['productPriceBeforeDiscount']);?>"  class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text"    name="productprice"  placeholder="Entrer le Prix ​​du produit" value="<?php echo htmlentities($row['productPrice']);?>" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<textarea  name="productDescription"  placeholder="Entrer la Description du produit" rows="6" class="span8 tip">
...
<div class="controls">
<input type="text"    name="productShippingcharge"  placeholder="Enterer le Frais d'expédition du produit" value="<?php echo htmlentities($row['shippingCharge']);?>" class="span8 tip" required>
</div>
</div>

<div class="control-group">
<label class="control-label" for="basicinput">Disponibilité du produit</label>
<div class="controls">

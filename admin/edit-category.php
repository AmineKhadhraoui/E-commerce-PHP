...
$_SESSION['msg']="Categorie Mettre à Jour !!";
...
<div class="controls">
<input type="text" placeholder="Entrer le nom du categorie"  name="category" value="<?php echo  htmlentities($row['categoryName']);?>" class="span8 tip" required>
</div>
</div>
